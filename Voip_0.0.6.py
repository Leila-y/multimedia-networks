...
CONFIG = {
    "sampling_rate": 44100,  # Increased sampling rate for better quality
...
def sample_voice(voice_data, target_rate):
    print("Sampling voice...")
    number_of_samples = int(len(voice_data) * target_rate / CONFIG['sampling_rate'])
    resampled_voice_data = scipy.signal.resample(voice_data, number_of_samples)
    print("Sampled voice.")
    return voice_data
...
def voip_service():
    while True:
        ...
        sampled_data = sample_voice(voice_data, 8000)
